...
/*
Can make date in the past
        var today = new Date();
        //var Curdate = today.getDate();
        var timezone = $A.get("$Locale.timezone");
        var Curdate  = $A.localizationService.formatDate(new Date(), "YYYY-MM-DD");
        console.log('*Curdate**'+Curdate);
        console.log('*checkDate1**'+checkDate);
        if(checkDate < Curdate){
            
            checkDate = Curdate;
            console.log('*checkDate2**'+checkDate);
        }
*/
        for(var key in fullOrderList){
            fullOrderList[key].IsEdited = true;
            ...
            console.log('*Start Date**'+fullOrderList[key].OppServiceDate );
        ...
        for(var key in fullOrderList){
            ...
            if(fullOrderList[key].ItemId == ItemId){
                ...
                if(newquantity>0){
                    ...
                    //  console.log('**OppTerms**'+parseFloat(fullOrderList[key].OppTerms));
                    //   console.log('**LicenceDuration**'+parseFloat(fullOrderList[key].LicenceDuration));
                    //   console.log('**checkMultiple**'+checkMultiple);
                        if(checkMultiple>0){
                            updateAllowed = false;
    ...
    ChangeOrderLineType: function(component, event, helper) {
        ...
        console.log('**ChangeOrderLineType**:Two');
                      var curOrder =  component.get("v.curOrder");
